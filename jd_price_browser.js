...
[task_local]
#京东模拟保价
cron "0 22 * * *" jd_jingfen.js, tag:京东模拟保价
 */

const $ = new Env('京东模拟保价');
...
async function browse(cks) {
   ...
   try{
       console.log("正在保价。。。")
        await page.goto("https://msitepp-fm.jd.com/rest/priceprophone/priceProPhoneMenu")
        await page.waitForTimeout(3000)
        await page.setCookie(...cks)
        await page.goto("https://msitepp-fm.jd.com/rest/priceprophone/priceProPhoneMenu")
        await page.waitForTimeout(3000)
        try{
            await page.click("#one-btn.one-btn")
